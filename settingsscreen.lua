...
local function configureBackgroundEffect()
        ...
        local accentSeed = copyColor(Theme.borderColor or Theme.progressColor or {0.35, 0.3, 0.5, 1})
        local accentColor = lightenColor(copyColor(accentSeed), 0.18)
        accentColor[4] = 1

        local pulseSeed = Theme.highlightColor or Theme.accentTextColor or accentSeed
        ...
        effect.vignetteOverlay = {
                color = withAlpha(lightenColor(copyColor(accentSeed), 0.05), 0.26),
                alpha = 0.26,
                steps = 3,
                thickness = nil,
        }
