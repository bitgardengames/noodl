...
function ArenaGen.generate(options)
        ...
        baseSeed = baseSeed + floorNum * 173 + math.floor((options.variantIndex or 0) * 911)
        ...
        for attempt = 0, math.max(0, attempts - 1) do
                ...
                mask.metadata.variant = options.variant
                mask.metadata.variantName = options.variantName
                mask.metadata.variantIndex = options.variantIndex
        ...
        bestMask.metadata.variant = options.variant or bestMask.metadata.variant
        bestMask.metadata.variantName = options.variantName or bestMask.metadata.variantName
        bestMask.metadata.variantIndex = options.variantIndex or bestMask.metadata.variantIndex
        bestMask.metadata.theme = options.theme or bestMask.metadata.theme
        bestMask.metadata.floor = floorNum or bestMask.metadata.floor
