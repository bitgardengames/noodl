...
* **Rare:** Dual-tone gradient border, ambient particle specks that idle at 20% opacity, and a slow 8 s breathing scale on the glow layer. Study **Mirror Mantle (Rare)** and **Stormchaser Rig (Rare)** to align color cues with defense and mobility tags in the [Card Catalog](card_catalog.md).
...
* All easing uses cubic-bezier(0.2, 0.8, 0.2, 1) for enter/exit, with back-ease reserved for celebratory reveals (first copy of **Mercantile Echo (Rare)**).
