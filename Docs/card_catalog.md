...
| --- | --- | --- | --- |
| Amber Bloom | Common | Track shattered rocks; every third one forges 25% shield progress, letting environmental cleanup snowball into extra protection. | Tags: defense; Visual: Shield progress burst when shattered rocks add protection. |
...
| Chrono Ward | Rare | Each time a shield is consumed, time slows briefly so you can thread through danger. | Tags: defense, utility; Unlock tag: timekeeper; Visual: Shield badge burst on purchase. |
...
| Warden's Chorus | Rare | Each Defense upgrade adds shield progress at the start of every floor. | Tags: defense; Requires tags: defense; Unlock tag: specialist; Visual: Shield pulse when floor-start shields are granted. |
| Zephyr Coils | Rare | Snake moves 20% faster. You gain +1 extra growth. | Tags: mobility, risk |
| Abyssal Catalyst | Epic | Instantly gain a shield and stronger combo rewards, but lasers charge and fire faster with shorter cooldowns. | Tags: defense, risk; Visual: Abyssal catalyst ring on purchase. |
| Chronospiral Core | Epic | Saws move 25% slower and spin 40% slower. Combo rewards increase by 60%. You grow by +4 and gain +1 extra growth. | Tags: combo, defense, risk; Weight: 1; Visual: Chronospiral flare on purchase. |
| Deliberate Coil | Epic | Snake moves 15% slower. The exit unlocks one fruit later. | Tags: speed, risk; Visual: Coiled focus aura on purchase. |
| Phoenix Echo | Epic | Once per run, a fatal crash rewinds without resetting the floor. | Tags: defense, risk; Visual: Phoenix flare when the rewind triggers. |
| Solar Reservoir | Epic | The first fruit each floor stalls saws for 2s and grants +4 bonus score. | Tags: economy, defense |
| Spectral Harvest | Epic | Once per floor, an echo collects the next fruit immediately after you do. | Tags: economy, combo |
| Titanblood Pact | Epic | Gain +3 shields and +2s saw stall duration. Grow by +5 and gain +2 extra growth. | Tags: defense, risk; Weight: 1 |
| Event Horizon | Legendary | Colliding with a wall opens a portal that ejects you from the opposite side of the arena. | Tags: defense, mobility; Unlock tag: legendary; Weight: 1; Visual: Event horizon portal burst on purchase. |
