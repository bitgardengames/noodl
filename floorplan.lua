...
local FLOOR_LAYOUT_OVERRIDES = {
        [1] = { preset = "botanical", densityRange = { min = 0.045, max = 0.085 }, seedOffset = 11 },
        [2] = { preset = "cavern", densityRange = { min = 0.05, max = 0.088 }, seedOffset = 23 },
        ...
        [5] = { preset = "machine", densityRange = { min = 0.055, max = 0.105 }, seedOffset = 53 },
        ...
        [9] = { preset = "desert", densityRange = { min = 0.06, max = 0.12 }, seedOffset = 97 },
...
local function getArenaLayoutConfig(floorIndex, plan)
        ...
        local seedOffset = (override and override.seedOffset) or config.seedOffset or 0
        config.seed = seedOffset + floorIndex * 211 + math.floor(((plan and plan.saws) or 0) * 13)
