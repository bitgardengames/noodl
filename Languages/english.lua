local english = {
    ...
    strings = {
        ...
        gameover = {
            ...
            meta_progress_gain = "${fruit} fruit converted into ${points} meta points!",
            meta_progress_bonus = "Run bonus: +${bonus}",
            meta_progress_level_label = "Level ${level}",
            meta_progress_total_label = "Lifetime Points: ${total}",
            meta_progress_next = "${remaining} points to next level",
            meta_progress_max_level = "Max level reached!",
            meta_progress_no_events = "Keep climbing to unlock upcoming rewards.",
            meta_progress_level_up = "Level ${level} reached!",
            meta_progress_level_up_subtitle = "Meta systems expanding soon.",
            meta_progress_unlock_header = "Unlock: ${name}",
            meta_progress_milestone_header = "Milestone",
            meta_progress_milestone = "${threshold} lifetime points celebrated!",
            deaths = {
                self = {
