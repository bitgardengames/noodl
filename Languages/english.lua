        ...
        game = {
            story = {
                speakers = {
                    ...
                    trader = "Crossroads Trader",
                    mira = "Mender Mira",
                    broker = "Hazard Broker",
                    tinkerer = "Tinkerer Ferrum",
                    specter = "Wandering Specter",
                },
                floor1 = {
                    line1 = "Follow the fruit, little spark. I'll keep the grove's glow with you for a few floors yet.",
                },
                floor2 = {
                    line1 = "These roots bend kindly. Let the rhythm carry you before the dark begins.",
                },
                floor3 = {
                    line1 = "My voice thins past this drop. Trust the echoes, not the shadows between them.",
                },
                floor4 = {
                    line1 = "Hear how the stone repeats you? Keep your pace—hesitation feeds the rumble.",
                },
                floor5 = {
                    line1 = "The air tastes strange... like water that's forgotten the sun.",
                },
                floor6 = {
                    line1 = "Choices wait ahead. None walk alone forever.",
                },
                floor7 = {
                    line1 = "Every traveler trades here. Will you carry guidance or sharpen the danger?",
                },
                floor8 = {
                    line1 = "The plaza fades. Whoever you chose walks beside you now.",
                    ally = "I'll sweep the stray blades when I can. Keep slithering.",
                    hazard = "Brave choice. I tossed in a fresh saw to honor it.",
                },
                floor9 = {
                    line1 = "Reflections ask for more. Do you steady the light or invite the storm?",
                    bloom = "Your bloomward bond hums through these prisms.",
                    shadow = "A shadow pact? I'll tune the traps to your tempo.",
                },
                floor10 = {
                    line1 = "The corruption names itself ahead. Hold tight to what you chose.",
                    ally = "Heat's brutal, but my wards still spark. Grab fruit and breathe.",
                    hazard = "Even the embers respect a daredevil. Revel in the pressure.",
                },
                floor11 = {
                    bloom = "Bloomlight leaps ahead, softening their swings.",
                    shadow = "Shadow-fused gears spin faster, just as you bargained.",
                    resonant = "Your calm resonance steadies the phantoms. They echo your stride.",
                    tempest = "You invited the gale; the spirits whirl to match.",
                },
                floor12 = {
                    line1 = "Every path you took now collides. Keep your focus; it's almost done.",
                },
                floor13 = {
                    line1 = "Strike the cleansing nodes with fruit. Each flare unwinds the blight.",
                    resonant = "Your resonance soothes the core; the nodes yield faster.",
                },
                floor14 = {
                    line1 = "The grove hears you returning. Let it know who you became.",
                    ally = "We made it back, spark! The grove already hums with our work.",
                    hazard = "Even the grove respects a daredevil. Enjoy the spoils.",
                    glimmer = "Your pact leaves new tools in the boughs. They'll remember.",
                    astral = "The astral path you carved now shimmers for those who follow.",
                },
                choices = {
                    crossroads = {
                        title = "Who guides this stretch?",
                        prompt = "Select a boon before you descend.",
                        ally_name = "Mira's Aid",
                        ally_desc = "Mender Mira slows saws after each fruit and carries a lighter fruit goal.",
                        ally_trait_name = "Mira's Support",
                        ally_trait_desc = "Fruit goal -2. Saws stall longer after each fruit.",
                        hazard_name = "Hazard Broker's Bargain",
                        hazard_desc = "Invite an extra saw and richer rockfalls for a sharper challenge.",
                        hazard_trait_name = "Hazard's Tax",
                        hazard_trait_desc = "+1 saw. Rocks spawn more often.",
                    },
                    glimmer = {
                        title = "How do you harness the mist?",
                        prompt = "Accept a gift or lean into the peril.",
                        bloom_name = "Bloomward Beacon",
                        bloom_desc = "Soft light eases rockfalls and nudges the goal closer.",
                        bloom_trait_name = "Bloom Shield",
                        bloom_trait_desc = "Fruit goal -1. Rocks spawn less often.",
                        shadow_name = "Shadow Toll",
                        shadow_desc = "Faster blades for greater rewards.",
                        shadow_trait_name = "Shadow Debt",
                        shadow_trait_desc = "+1 saw. Saws move 12% faster.",
                    },
                    astral = {
                        title = "Align with the echoes or the storm?",
                        prompt = "Pick the resonance that fits your run.",
                        resonant_name = "Resonant Path",
                        resonant_desc = "Ease the pressure; a saw rests and stuns longer.",
                        resonant_trait_name = "Resonant Calm",
                        resonant_trait_desc = "-1 saw. Saws stall longer after fruit.",
                        tempest_name = "Tempest Route",
                        tempest_desc = "Whip the hazards to life for sharper scoring.",
                        tempest_trait_name = "Tempest Surge",
                        tempest_trait_desc = "Saws speed up 18%. +2 rocks.",
                    },
                },
            },
            floor_traits = {
