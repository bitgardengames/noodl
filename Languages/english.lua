	...
	strings = {
		...
		settings = {
			...
			back = "Back",
                ...
                render = {
                        title = "Render Canvas",
                        subtitle = "Promotional capture sandbox",
                        description = "Arrange the snake, fruit, saws, lasers, and rocks for artwork.\nHide the overlay (Tab) before exporting for a clean PNG.",
                        shortcuts = "Shortcuts: Tab – Toggle overlay, B – Toggle background, P – Capture PNG",
                        toggle_overlay = "Toggle Overlay",
                        toggle_background = "Toggle Background",
                        capture = "Capture PNG",
                        back = "Back to Dev Page",
                        capture_success = "Saved ${file}",
