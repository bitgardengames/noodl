		...
		common = {
			...
			day_unit_plural = "days",
                ...
                menu = {
                        ...
                        version = "v1.0.0",
                        title_word = "noodl",
                        hero_tagline = "Slice the skyline, serve the chaos.",
                        group_primary = "Play",
                        group_secondary = "Explore",
			...
			daily_panel_keep_alive = "Don't miss today's challenge to keep it alive!",
                        ...
                        weekly_panel_header = "Weekly Warmup",
                        weekly_panel_title = "Chef's Prep Course",
                        weekly_panel_description = "Clear five runs this week to earn a stocking of upgrade tokens.",
                        weekly_panel_status = "Runs completed: ${current}/${goal}",
                        weekly_panel_hint = "Tackle a floor or two each day to keep the momentum sizzling.",
                        community_panel_header = "Community Spotlight",
                        community_panel_title = "Noodl Showcase",
                        community_panel_description = "Share your stylish clears with #noodl and get featured here!",
                        community_panel_status = "Top shared score: ${score}",
                        community_panel_hint = "Tag your clips for a chance to land on next week's marquee.",
                        highlight_cycle_hint = "Press Q/E or tap the arrows to browse highlights.",
                        daily = {
                                combo = {
                                        title = "Combo Crunch",
