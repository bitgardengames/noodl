...
local Floors = {
        [1] = {
                ...
                palette = {
                        bgColor     = {0.11, 0.2, 0.26, 1},
                        arenaBG     = {0.26, 0.52, 0.44, 1},
                        arenaBorder = {0.83, 0.62, 0.34, 1},
                        snake       = {0.38, 0.86, 0.68, 1},
                        rock        = {0.44, 0.54, 0.48, 1},
                },
                backgroundEffect = {
                        type = "gardenMellow",
        ...
        [7] = {
                ...
                palette = {
                        bgColor    = {0.78, 0.84, 0.94, 1},
                        arenaBG    = {0.92, 0.97, 1.0, 1},
                        arenaBorder= {0.72, 0.86, 0.96, 1},
                        snake      = {0.96, 0.82, 0.52, 1},
                        rock       = {0.56, 0.68, 0.86, 1},
