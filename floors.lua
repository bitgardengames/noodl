...
flavor = "Gentle auric petals unfurl in hush-soft rings while Noodl makes the first serene offerings.",
        palette = {
            bgColor     = {0.05, 0.03, 0.08, 1},
            arenaBG     = {0.14, 0.09, 0.18, 1},
            arenaBorder = {0.92, 0.72, 0.88, 1},
            snake       = {0.96, 0.88, 0.74, 1},
            rock        = {0.32, 0.26, 0.34, 1},
            sawColor    = {0.76, 0.75, 0.78, 1},
            arenaHighlight = {0.98, 0.82, 0.9, 1},
        },
backgroundEffect = {
type = "petalCascade",
