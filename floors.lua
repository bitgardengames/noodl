...
local Floors = {
    ...
    [4] = {
        ...
        palette = {
            bgColor    = {0.07, 0.12, 0.14, 1},   -- deep teal void
            arenaBG    = {0.11, 0.2, 0.24, 1},    -- water-stained slate with a cooler tint
            arenaBorder= {0.12, 0.32, 0.34, 1},   -- moss-bright cyan edge
            snake      = {0.35, 0.9, 0.85, 1},    -- luminous aqua
            rock       = {0.32, 0.58, 0.63, 1},   -- sea-washed teal stone with algae sheen
