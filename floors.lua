...
local Floors = {
    ...
    [4] = {
        ...
        palette = {
            bgColor    = {0.05, 0.1, 0.13, 1},    -- midnight brine
            arenaBG    = {0.09, 0.17, 0.21, 1},   -- submerged slate
            arenaBorder= {0.19, 0.41, 0.4, 1},    -- algae-lit stone rim
            snake      = {0.58, 0.95, 0.78, 1},   -- phosphorescent jade
            rock       = {0.24, 0.46, 0.5, 1},    -- barnacled basalt
            sawColor   = {0.68, 0.88, 0.91, 1},   -- corroded silver sheen
        },
        backgroundEffect = {
            type = "softCurrent",
    ...
    [7] = {
        ...
        palette = {
            bgColor    = {0.13, 0.12, 0.11, 1},   -- crypt dusk
            arenaBG    = {0.21, 0.19, 0.16, 1},  -- dusted ochre soil
            arenaBorder= {0.55, 0.46, 0.32, 1},   -- patina bone rim
            snake      = {0.9, 0.86, 0.76, 1},    -- weathered ivory
            rock       = {0.6, 0.5, 0.37, 1},     -- fossil shards
            sawColor   = {0.7, 0.63, 0.48, 1},    -- tarnished brass flare
        },
        backgroundEffect = {
            type = "echoMist",
